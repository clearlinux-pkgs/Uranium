...
Version  : 4.2.0
Release  : 6
URL      : https://github.com/Ultimaker/Uranium/archive/4.2.0/Uranium-4.2.0.tar.gz
Source0  : https://github.com/Ultimaker/Uranium/archive/4.2.0/Uranium-4.2.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1565053501
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/uranium/plugins/FileHandlers/OBJReader/tests/conftest.py
...
/usr/lib64/uranium/plugins/FileHandlers/STLReader/tests/conftest.py
...
/usr/share/package-licenses/Uranium/LICENSE
