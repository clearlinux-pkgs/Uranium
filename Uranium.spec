...
Version  : 4.12.0
Release  : 42
URL      : https://github.com/Ultimaker/Uranium/archive/4.12.0/Uranium-4.12.0.tar.gz
Source0  : https://github.com/Ultimaker/Uranium/archive/4.12.0/Uranium-4.12.0.tar.gz
...
%prep
%setup -q -n Uranium-4.12.0
cd %{_builddir}/Uranium-4.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1636574026
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/Uranium-4.12.0/LICENSE %{buildroot}/usr/share/package-licenses/Uranium/b0285d2a104d4e90b17a2db8a713bd441745b793
pushd clr-build
%make_install
popd
...
/usr/lib64/uranium/plugins/UpdateChecker/NewBetaVersionMessage.py
/usr/lib64/uranium/plugins/UpdateChecker/NewVersionMessage.py
...
/usr/lib64/uranium/plugins/UpdateChecker/tests/CuraAndCuraBeta1-0-0.json
/usr/lib64/uranium/plugins/UpdateChecker/tests/CuraOnly1-0-0.json
/usr/lib64/uranium/plugins/UpdateChecker/tests/TestUpdateChecker.py
/usr/lib64/uranium/plugins/UpdateChecker/tests/__init__.py
...
%files data
%defattr(-,root,root,-)
/usr/share/cmake-3.21/Modules/UraniumTranslationTools.cmake
