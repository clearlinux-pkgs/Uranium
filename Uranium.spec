...
Version  : 4.1.0
Release  : 5
URL      : https://github.com/Ultimaker/Uranium/archive/4.1.0/Uranium-4.1.0.tar.gz
Source0  : https://github.com/Ultimaker/Uranium/archive/4.1.0/Uranium-4.1.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1563994708
mkdir -p clr-build
pushd clr-build
