...
Source0  : https://github.com/Ultimaker/Uranium/archive/4.4.1/Uranium-4.4.1.tar.gz
...
%prep
%setup -q -n Uranium-4.4.1
cd %{_builddir}/Uranium-4.4.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1580429256
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/Uranium-4.4.1/LICENSE %{buildroot}/usr/share/package-licenses/Uranium/b0285d2a104d4e90b17a2db8a713bd441745b793
pushd clr-build
%make_install
popd
