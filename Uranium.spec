...
Version  : 4.7.0
Release  : 20
URL      : https://github.com/Ultimaker/Uranium/archive/4.7.0/Uranium-4.7.0.tar.gz
Source0  : https://github.com/Ultimaker/Uranium/archive/4.7.0/Uranium-4.7.0.tar.gz
...
%prep
%setup -q -n Uranium-4.7.0
cd %{_builddir}/Uranium-4.7.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1598468535
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/Uranium-4.7.0/LICENSE %{buildroot}/usr/share/package-licenses/Uranium/b0285d2a104d4e90b17a2db8a713bd441745b793
pushd clr-build
%make_install
popd
